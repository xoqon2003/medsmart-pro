  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground flex-1 text-center font-medium text-[0.75rem] py-1",
        ...
        day: cn(
          ...
          "w-full aspect-square max-h-9 p-0 font-normal aria-selected:opacity-100 rounded-full",
        ),
        day_range_start:
